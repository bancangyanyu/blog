...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    logo: '/img/logo-blog.svg', // 导航栏logo
    repo: 'bancangyanyu', // 导航栏右侧生成Github链接
  ...
  plugins: [ // 插件
    ...
    ['thirdparty-search', { // 可以添加第三方搜索链接的搜索框（原官方搜索框的参数仍可用）
      thirdparty: [ // 可选，默认 []
        ...
        {
          title: '通过百度搜索本站的', 
          frontUrl: 'https://www.baidu.com/s?wd=site%3Abzyycn.cn%20'
        }
      ]
    }],
    ...
    [
      ...
      // },
      {
        ...
        options: {
          ...
          id: "<%- (frontmatter.permalink || frontmatter.to.path).slice(-16) %>", //  的唯一标识,长度不能超过50
          title: "「评论」<%- frontmatter.title %>", // GitHub issue 的标题
          labels: ["Gitalk", "Comment"], // GitHub issue 的标签
          body: "页面：<%- window.location.origin + 'bzyy_blog'+ (frontmatter.to.path || window.location.pathname) %>" // GitHub issue 的内容
        }
      }
    ], 
    [
